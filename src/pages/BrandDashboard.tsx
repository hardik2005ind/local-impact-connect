...
import { Search, Filter, MapPin, Users, Heart, MessageCircle, Star, Crown, TrendingUp } from 'lucide-react';
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center gap-4 mb-4">
                      <Avatar className="h-12 w-12 ring-2 ring-pink-200">
                        ...
                        <AvatarFallback className="bg-pink-100 text-pink-700">{creator.name.split(' ').map(n => n[0]).join('')}</AvatarFallback>
                      </Avatar>
                      <div>
                    ...
                    <div className="flex justify-between items-center mb-4">
                      <Badge variant="secondary" className="bg-pink-100 text-pink-700 border-pink-200">{creator.niche}</Badge>
                      <div className="flex items-center gap-1 text-gray-600">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-center mb-6 p-3 bg-pink-50/50 rounded-lg">
                      <div>
                        ...
                        <span className="text-xs text-gray-600 font-medium">{creator.avgLikes}</span>
                      </div>
                      <div>
                        <div className="flex items-center justify-center gap-1 mb-1">
                          <MessageCircle className="h-3 w-3 text-blue-500" />
                        </div>
                        <span className="text-xs text-gray-600 font-medium">{creator.avgComments}</span>
                      </div>
                      <div>
                        <div className="flex items-center justify-center gap-1 mb-1">
                          <TrendingUp className="h-3 w-3 text-green-500" />
                        </div>
                        <span className="text-xs text-gray-600 font-medium">{creator.engagement}</span>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4">
                          <Badge variant={campaign.status === 'Active' ? 'default' : 'secondary'} 
                                 className={campaign.status === 'Active' ? 'bg-green-100 text-green-700 border-green-200' : 'bg-gray-100 text-gray-700'}>
                            {campaign.status}
                          </Badge>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-pink-100 shadow-lg">
              <CardContent className="p-12">
                <div className="text-center py-16">
                  ...
                  <h3 className="text-2xl font-semibold text-gray-900 mb-4">Campaign Builder Coming Soon</h3>
                  <p className="text-gray-600 text-lg mb-8 max-w-md mx-auto">We're crafting an amazing campaign creation experience that will make launching your next campaign effortless.</p>
                  <Button className="gradient-pink-maroon text-white hover:opacity-90 transition-opacity">
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-pink-100 shadow-lg">
              <CardContent className="p-12">
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-600 text-lg mb-8 max-w-md mx-auto">Comprehensive brand profile management tools are being developed to give you complete control over your brand presence.</p>
